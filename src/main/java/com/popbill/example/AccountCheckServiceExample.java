 ...
 * https://developers.popbill.com/guide/accountcheck/java/getting-started/tutorial?fwn=springmvc -
 ...
 * util:properties 의 링크아이디(LinkID)와 비밀키(SecretKey)를 연동신청 시 메일로 발급받은 인증정보를 참조하여 변경합니다.
 */
	...
	public String checkDepositorInfo(Model m) {
		...
		try {
			...
			DepositorCheckInfo depositorCheckInfo = accountCheckService.CheckDepositorInfo(
					testCorpNum, BankCode, AccountNumber, IdentityNumType, IdentityNum);
